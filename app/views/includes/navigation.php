<div id="slidePanel" class="fixed z-[9999] top-1/2 -right-[0.5rem] transform -translate-y-1/2 w-[3rem] md:w-[5.5rem] text-xs lg:text-sm space-y-[0.4rem] md:space-y-[0.6rem] transition-all duration-900 ease-in-out">
